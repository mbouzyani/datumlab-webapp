...
export class DvTcComponent implements OnInit {
  ...
  optionSpiderChart :any = {
    ...
    xAxis: {
        ...
        labels: {
          ...
          formatter: function () {
            console.log(this)
            let categories = ['10-15', '15-20', '20-25', '25-30', '30-35', '35-40', '45-50', '55-60'];
            let gradientColorRed=[ "#4e4ef3", "#fae1e1", "#fac8c8", "#fa9696", "#fa7d7d"  , "#fa6464", "#fa4b4b", "#fa3232"];
  ...
  async displayDataOne(dataToSend){
    ...
    this.optionSpiderChart.title.text = " Vélocité de Conclusion des Contrats "+ (dataToSend.city ? '/ '+dataToSend.city : "");
    Highcharts.chart("container-dv-cc-tc-1", this.optionSpiderChart);
