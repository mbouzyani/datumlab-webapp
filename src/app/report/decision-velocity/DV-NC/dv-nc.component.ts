...
export class DVNCComponent implements OnInit {
 ...
 async displayDataOne(dataToSend){
    ...
    this.optionOne.title.text = 'Vélocité de Décision '+ (dataToSend.city ? ' / '+dataToSend.city : "");
    
    
    this.chart = Highcharts.chart("container-dv-nc-1", this.optionOne);
  }
