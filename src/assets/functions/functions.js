...
function exportListAgence() {
    // import * as ListToExport from '../../../data/VD-DA/listExport/list.json';
    // import * as XLSX from 'xlsx';

    // const workBook = XLSX.utils.book_new(); 
    // workBook.Props = {};
    // workBook.Props.Title = "Liste des Agences Vélocité de Décision Demande et Autorisaton pour la banque ";
    // workBook.Custprops = {};
